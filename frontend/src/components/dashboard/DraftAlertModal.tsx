                    ...
                    <>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    onClick={() =>
                                        handleCopy(drafts.sms_draft, "sms")
                                    }
                            ...
                            <div className="p-3 bg-white border border-slate-200 rounded-md text-sm text-slate-700 font-medium">
                                {drafts.sms_draft}
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    onClick={() =>
                                        handleCopy(drafts.email_draft, "email")
                                    }
                                    className="flex items-center gap-1.5 text-xs font-medium text-slate-500 hover:text-slate-800 bg-white border border-slate-200 px-2 py-1 rounded shadow-sm cursor-pointer transition-colors"
                                >
                                    {copiedEmail ? (
