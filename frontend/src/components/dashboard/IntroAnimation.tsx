...
export default function IntroAnimation({
	...
	return (
		<div className={phase === "done" ? "relative" : "fixed inset-0 z-[9999]"}>
			<div className="absolute inset-0 z-0">{children}</div>

			<div
				className="absolute opacity-0 pointer-events-none w-14 h-14"
				aria-hidden
			>
				<Image
					src={orgLogoAltSrc}
			...
			{isSpread && (
				<motion.div
					initial={{
						clipPath: "inset(0% calc(50% - 1px) 0% calc(50% - 1px))",
					}}
